...
{
    #[\Override] public function name(): string { return 'sqlite'; }
    #[\Override] public function isSqlite(): bool { return true; }
    #[\Override] public function supportsAddPrimaryKey(): bool { return false; }
    #[\Override] public function supportsAlterForeignKeys(): bool { return false; }
    #[\Override] public function compileDropForeign(string $table, string $name): string { unset($table, $name); $this->unsupported('drop foreign key'); }
    #[\Override] public function compileDropPrimary(string $table, ?string $name): string { unset($table, $name); $this->unsupported('drop primary key'); }
    #[\Override] public function compileRenameIndex(string $table, string $from, string $to): string { unset($table, $from, $to); $this->unsupported('rename index'); }
    #[\Override] public function beforeDropAllStatements(): array { return ['PRAGMA foreign_keys = OFF']; }
    #[\Override] public function afterDropAllStatements(): array { return ['PRAGMA foreign_keys = ON']; }
