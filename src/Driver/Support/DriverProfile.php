...
/**
 * Central driver metadata needed outside concrete driver classes.
 */
final class DriverProfile
{
    ...
    private const array DEADLOCK_MESSAGE_HINTS = [
        ...
        'mariadb' => ['deadlock'],
        'pgsql' => ['deadlock detected', 'deadlock'],
        'postgres' => ['deadlock detected', 'deadlock'],
        'sqlite' => ['database is locked', 'deadlock'],
        'mssql' => ['deadlock victim', 'deadlocked on lock resources', 'deadlock'],
        'default' => ['deadlock'],
    ];
    ...
    {
        return strtolower($driver) === 'mssql'
